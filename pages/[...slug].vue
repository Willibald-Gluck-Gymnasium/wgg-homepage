<script setup>
const data = await queryContent(useActiveRoute().path).findOne()
</script>
  ...
  <NuxtLayout>
    <main>
      <div class="article-container manual-scope-XKpYE">
          <div id="wrapper">
              <div class="header">
                  <NuxtLink :href="'tag/' + data.tags[0] || 'Allgemein'" class="category">{{ data.tags[0] || 'Allgemein' }}</NuxtLink>
                  <h1>{{ data.title }}</h1>
                  <div id="info" class="info">
                      ...
                      <div v-if="data.author" class="seperator">-</div>
                      <!-- <div class="readtime">
                          {{ readTime }}
                      </div> -->
              ...
              <div ref="articlecontent" id="articlecontent"><ContentDoc /></div>
