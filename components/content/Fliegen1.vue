...
export default {
    ...
    methods: {
        ...
        Fliege: function () {
            ...
            this.o.src = "/images/wahlkurse/theHomepageGames/Fliege.png";
            ...
            this.stirb = function () {
                this.tot = true;
                this.o.src = "images/wahlkurse/theHomepageGames/FliegeTot.png";
            ...
            this.maus = function (mx, my) {
                if (this.tot) return;
                var relMausVek = new this.Vector(this.x - mx, this.y - my);
    ...
    mounted() {
        ...
        if (level > 1) alert("Level: " + level + "\nWeihnachtsfliegenanzahl: " + a);
        this.spawn(a);
        this.aktiv = window.setInterval(this.bewegAlle, 100);
    }
}
</script>